  ...
  return (
    <div className="flex-1 w-full flex flex-col gap-8 max-w-4xl mx-auto">
      <div className="space-y-2">
        <h1 className="text-4xl font-bold">SMS Terms and Conditions</h1>
      ...
      <Card>
        ...
        <CardContent className="prose prose-sm max-w-none">
          ...
          <ul>
            <li><strong>Medication Reminders:</strong> Messages sent approximately 15 minutes before each scheduled medication dose</li>
            <li><strong>Welcome Messages:</strong> A confirmation message when you first opt into SMS notifications</li>
            <li><strong>Service Updates:</strong> Important service updates or alerts (sent infrequently)</li>
          </ul>
        </CardContent>
      </Card>
